...
class LangSAMAPI(ls.LitAPI):
    ...
    def predict(self, inputs: dict) -> dict:
        ...
        return {"output_image": output_image, "masks": masks.tolist(), "boxes": boxes.tolist(), "labels": labels, "scores": scores.tolist(), "num_object": num_object.tolist()}
